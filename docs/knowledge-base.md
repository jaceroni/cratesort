...
never change; the 15-genre taxonomy and why it's deliberately small — cross-ref
...
content-type bucket (not one of the 15 genres) and how it's triggered purely by
