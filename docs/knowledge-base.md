...
never change; the 16-genre taxonomy and why it's deliberately small — cross-ref
...
content-type bucket (not one of the 16 genres) and how it's triggered purely by
folder location, video or audio — cross-ref `CLAUDE-CS.md` → "Film & TV — a
content-type bucket, not a genre".)*
